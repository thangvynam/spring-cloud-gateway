 ...
 */
@Component
public class TelcoGatewayFilterFactory implements GatewayFilterFactory<TelcoGatewayFilterFactory.Config> {
    ...
    @Override
    public GatewayFilter apply(TelcoGatewayFilterFactory.Config config) {
